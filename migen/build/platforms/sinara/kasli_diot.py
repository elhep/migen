...
_connectors_diot_1v0 = [
    ...
    # LVDS pairs are swapped on the backplane, however, as mentioned in the
    # issue linked above, decrossing is done on the peripheral side, so the pinout
    # is as if the pairs were not swapped on the backplane.
    ('diot0', {
        'd0_cc_p': 'AJ28',
        'd0_cc_n': 'AK28',
        'd1_p': 'AM31',
